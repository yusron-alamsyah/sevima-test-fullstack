                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <h2>
                               <img src="https://sevima.com/wp-content/themes/sevima2019/img/logo-sevima.png" alt="CoolAdmin" />
                            </h2>
                        </div>
                        <div class="login-form">
                            <form action="" method="post" onsubmit="return ajax_action_login();">
                                ...
                                <button id="btn-login" class="au-btn au-btn--block btn-danger m-b-20" type="submit">sign in</button>
